...
class MCPClient:
    ...
    async def connect_to_server(self, server_script_path: str):
        try:
            # The server_script_path is a command, not a script file.
            # We can execute it directly without specifying an interpreter.
            server_params = StdioServerParameters(
                command=server_script_path, args=[], env=None
            )
